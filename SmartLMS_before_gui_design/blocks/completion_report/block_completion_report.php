...
//					$str_output .= "&nbsp;&nbsp;&nbsp;<b><a title='" . get_string('generatereport', 'block_completion_report') .  "' href='" . $CFG->wwwroot . "/blocks/" . $this->name() . "/report.php" . $str_course . "'>" . get_string('generatereport', 'block_completion_report') .  "</a></b><br />";
					
					
					$str_output .= "<a href='/mod/smartcom/index.php?courseid={$this->courseid}&submodule=course_completion_suggest_configure' >Configure this course auto completion behavior</a>";
					// HACKED: LockeVN:
