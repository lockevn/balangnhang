...
*/
	...
	*/
    if (!function_exists('build_navigation')){
        ...
        $navigation = build_navigation(array(array('name'=>$strtitle, 'link'=>" $courselink "."<a href=\"view.php?id=$id\">".get_string("filemanager", 'block_file_manager')."</a> -> ".get_string("categories", 'block_file_manager'), 'type'=>'misc')));
