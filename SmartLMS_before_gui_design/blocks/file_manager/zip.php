...
/*********************************************************/
    ...
    print_header(strip_tags(get_string("filemanager", 'block_file_manager')), "$course->fullname",
        " $courselink <a href=\"view.php?id={$id}&amp;rootdir={$rootdir}&groupid={$groupid}\">".get_string("filemanager", 'block_file_manager')."</a> -> ".get_string('zipfiles','block_file_manager'), "", "", true, "",
        navmenu($course, 1),"","");
