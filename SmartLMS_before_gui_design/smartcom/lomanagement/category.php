 ...
 */
    ...
    require_once($CFG->dirroot."/smartcom/lomanagement/editlib.php");
    require_once($CFG->dirroot."/smartcom/lomanagement/category_class.php");



    list($thispageurl, $contexts, $cmid, $cm, $module, $pagevars) = lo_edit_setup('categories');
    ...
    $qcobject = new lo_category_object($pagevars['cpage'], $thispageurl, $contexts->having_one_edit_tab_cap('categories'), $param->edit, $pagevars['cat'], $param->delete,
