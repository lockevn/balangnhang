...
class block_file_manager extends block_list {
	...
	*/
	function display_filemanager_link() {
		...
		$id      = optional_param('id', 0, PARAM_INT); // The Id of the current course
        ...
        if ($id){
    		...
    		$editingteacher = has_capability('moodle/legacy:editingteacher', $context);
    		$coursecreator = has_capability('moodle/legacy:coursecreator', $context);
    	}
	...
	*/
	function fm_get_user_int_type() {
	    ...
	    // This is an old strategy that should be changed with capabilities
	...
	*/	
	...
	/*Ajouté par MJ Leblanc pour empêcher d'ajouter le bloc dans mymoodle*/
