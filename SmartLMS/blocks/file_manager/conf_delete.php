...
" $courselink <a href=\"view.php?id={$id}&groupid={$groupid}\">".get_string('filemanager', 'block_file_manager').'</a> -> '.
    	...
    	$strtitle = strip_tags(get_string('confdelete', 'block_file_manager'));
        $navigation = build_navigation(array(array('name'=>$strtitle, 'link'=>" $courselink <a href=\"view.php?id={$id}&groupid={$groupid}\">".get_string('filemanager', 'block_file_manager').'</a> -> '.
		get_string('confdelete', 'block_file_manager'), 'type'=>'misc')));
