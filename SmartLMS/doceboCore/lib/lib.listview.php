...
require_once(dirname(__FILE__) . '/lib.typeone.php');
...
class ListView {
	...
	function _getCreateLabel() { return $this->lang->def('_CREATEITEM'); }
	function _getCreateUrl() { return $this->_getOpCreateItemId(); }
	function _getCreateAlt() { return $this->lang->def('_CREATEITEM'); }
	...
	function ListView( $title, &$data, &$rend, $id ) {
		...
		$this->startRow = importVar( 'ini', TRUE, 0 );
	}
