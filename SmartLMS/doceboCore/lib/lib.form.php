...
class Form {
	 ...
	 */
	function getDatefield( $label_name, $id, $name, $value = '', $date_format = FALSE, $sel_time = FALSE, $alt_name = '', $other_after = '', $other_before = '', $other_param = '') {
	   ...
	   if(getAccessibilityStatus() == true) {
			...
			return  Form::getLineTextfield( 'form_line_l', 'floating', $label_name, 'textfield',
										$id, $name, $value, $alt_name, '30', $other_param,
	 ...
	 */
	function getInputPassword( $css_text, $id, $name, $alt_name, $maxlenght, $other_param, $value ) {
	 ...
	 * @return string with the html code for a line with the input type="text" element
	 */
	function getLinePassword( $css_line, $css_label, $label_name, $css_text, $id, $name, $alt_name, $maxlenght, $other_param, $other_after, $other_before, $value = '' ) {
		return '<div class="'.$css_line.'">'
			.$other_before
			.'<p><label class="'.$css_label.'" for="'.$id.'">'.$label_name.'</label></p>'
	 ...
	 * @return string with the html code for the input type="text" element
	 */
	function getPassword( $label_name, $id, $name, $maxlenght, $alt_name = '', $other_after = '', $other_before = '', $value = '' ) {
	 ...
	 */
	function getExtendedFileField($label_name, $id, $name, $value=FALSE, $filename=FALSE, $show_current=TRUE, $show_del_checkbox=TRUE, $add_old_info=TRUE, $old_prefix=FALSE, $del_arr_name=FALSE, $alt_name = '', $other_after = '', $other_before = '') {
		$res="";
		...
		if ($show_current) {
			...
			if (($value !== FALSE) && (!empty($value))) {
				...
				if ($show_del_checkbox) {
					...
					$checkbox.=Form::getLabel($check_id, def("_DELETE_FILE", "standard", "framework"), "no_float");
					$res.=Form::getLineBox($img." ".$filename, $checkbox);
				}
				else {
					$res.=Form::openFormLine();
					$res.=def("_CURRENT_FILE", "standard", "framework").": ".$img." ".$filename;
					$res.=Form::closeFormLine();
				}
			}
			else {
				$res.=Form::openFormLine();
				$res.=def("_CURRENT_FILE", "standard", "framework").": ".def("_NONE", "standard", "framework");
				$res.=Form::closeFormLine();
			}
		}
	 ...
	 * @return string with the html code for a line with the select element
	 */
	function getDropdown( $label_name, $id, $name, $all_value , $selected = '', $other_after = '', $other_before = '', $other_param = '' ) {
	...
	function getCheckbox( $label_name, $id, $name, $value, $is_checked = false, $other_param = '' ) {
		...
		return Form::getLineCheckbox( 'form_line_l', 'label_normal', $label_name, $id, $name, $value, $is_checked, $other_param );
	}
	 ...
	 * @return string with the html code for the input type="checkbox" element
	 */
	function getCheckboxSet( $group_name, $id, $name, $all_value , $selected = false, $other_after = '', $other_before = '' ) {
	...
	function getInputTextarea($id ,$name , $value = '', $css_text = false, $rows = 5, $cols = 22, $other_param = '' ) {
	...
	function getSimpleTextarea($label_name, $id ,$name , $value = '',
				$css_line = false, $css_label = false, $css_text = false, $rows = 5, $cols = 22 ) {
	...
	function openFormLine($id=FALSE) {
	 ...
	 */
	function getButton( $id, $name, $value, $css_button = FALSE, $other_param = '' ) {
