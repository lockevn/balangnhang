...
class Text
{
	...
	*/
	...
	private static function genChar($possible = '1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
	{		
	...
	public static function generateRandomStr($length = 4, $possible = '1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
	{
		$sRandom = '';
		for($i=0; $i<$length; $i++)
		{
			$sRandom .= Text::genChar($possible);
		}
		return $sRandom;
	}
