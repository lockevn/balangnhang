...
function subscriptionBlockEdit(& $out, & $lang, & $form, $block_id, $sub_id) {
...
function subscriptionBlockSave($block_id, $sub_id) {
...
function subscriptionBlockAdd($block_id, $sub_id) {
