 ...
 *
 * $Header: /cvs/bbclone/lib/new_connect.php,v 1.36 2006/12/27 17:01:44 christoph Exp $
 *
...
function bbc_get_extension($host, $addr) {
  ...
  $gen_ext = array(
    ...
    "int", "la", "mil", "ms", "museum", "name", "net", "nu", "org", "pro", "sc", "st", "su", "tk", "to", "tm", "tv",
    "vu", "ws"
  );
  ...
  $cnt_ext = array(
    ...
    "sn", "so", "sr", "sv", "sy", "sz", "tc", "td", "tf", "tg", "th", "tj", "tl", "tn", "tp", "tr", "tt", "tw", "tz",
