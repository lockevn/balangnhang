 ...
 * @version 	$Id: header.php,v 1.11 2005/11/10 14:33:27 gishell Exp $
 */

$GLOBALS['page']->add(
		'	<link href="'.getPathTemplate('framework').'style/style.css" rel="stylesheet" type="text/css" />'."\n"
		.'	<link href="'.getPathTemplate("ecom").'style/style.css" rel="stylesheet" type="text/css" />'."\n"
		.'	<link href="'.getPathTemplate("ecom").'style/style_treeview.css" rel="stylesheet" type="text/css" />'."\n"
		.'	<link href="'.getPathTemplate("ecom").'style/style_organizations.css" rel="stylesheet" type="text/css" />'."\n"
, 'page_head');
