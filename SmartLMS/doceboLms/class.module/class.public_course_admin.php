...
class Module_Public_Course_Admin extends LmsModule {
	
	function loadBody() {
		
		require_once(dirname(__FILE__).'/../modules/public_course_admin/public_course_admin.php');
		publicCourseAdminDispatch($GLOBALS['op']);
	}	
