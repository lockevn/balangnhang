<?php
    ...
    $string['lightboxgallery:addcomment'] = 'Add comment to course gallery';
    $string['lightboxgallery:addimage'] = 'Add image to course gallery';
    $string['lightboxgallery:edit'] = 'Edit a course gallery';
