...
/**
* @desc return the html string to display chart swfobject
*/
...
/**
* @desc echo the html to display swfobject of chart
*/
...
/**
* @desc Make a string that contain: the js to use swf. Print the swfobject to display chart
*/
