...
Finally, note that the tree display is only available in non-edit mode. Edit mode (teachers) will
display the course in standard topics format, in order to play with indentation and so on. No 100%
intuitive, but it's beyond the objectives of the format.

That's all, enjoy. Ciao, Eloy Lafuente (stronk7) 20090113
