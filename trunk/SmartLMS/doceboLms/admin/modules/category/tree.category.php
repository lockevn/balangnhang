...
if(!isset($GLOBALS['css_treeview_load']) && isset($GLOBALS['page'])) {//if(!isset($GLOBALS['css_treeview_load'])) {
	$GLOBALS['page']->add('<link href="'.getPathTemplate().'style/style_treeview.css" rel="stylesheet" type="text/css" />', 'page_head');
...
class TreeView_CatView extends TreeView {
	...
	function  TreeView_CatView($tdb, $id, $rootname = 'root') {
		...
		$user_lvl = $GLOBALS['current_user']->getUserLevelId();
	...
	function _getAddImage() 						{ return getPathImage('lms').'standard/add.gif'; }
	function _getAddLabel() 						{ return def('_NEW_CATEGORY', 'admin_course_managment', 'lms'); }
	function _getAddAlt() 							{ return def('_ADD', 'standard'); }
	function canAdd() 								{ return $this->can_add && !$this->hide_inline_action; }
	
	function _getRenameImage()						{ return getPathImage('lms').'standard/mod.gif'; }
	function _getRenameLabel() 						{ return def('_MOD_CATEGORY', 'admin_course_managment', 'lms'); }
	...
	function _getMoveLabel() 						{ return def('_MOVE_CATEGORY', 'admin_course_managment', 'lms'); }
	...
	function _getDeleteLabel() 						{ return def('_DEL', 'admin_course_managment', 'lms'); }
	function canDelete() { 
	...
	function _getMoveTargetLabel()					{ return def('_MOVE_CATEGORY', 'admin_course_managment', 'lms').' : '; }
	function _getCancelLabel()						{ return def('_UNDO', 'admin_course_managment', 'lms'); }
	...
	function loadDeleteFolder() {
		...
		return $this->printState()
			.getDeleteUi(	$lang->def('_AREYOUSURE'), 
							'<span class="text_bold">'.$lang->def('_COURSE_CATEGORY').' : </span>'
