...
function myfilesBlockEdit(& $out, & $lang, & $form, $block_id, $sub_id) {
...
function myfilesBlockSave($block_id, $sub_id) {
...
function myfilesBlockAdd($block_id, $sub_id) {
...
function myfilesBlockDel($block_id, $sub_id) {
}
