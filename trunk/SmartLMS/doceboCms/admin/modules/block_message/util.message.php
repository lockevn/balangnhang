...
function messageBlockEdit(& $out, & $lang, & $form, $block_id, $sub_id) {
...
function messageBlockSave($block_id, $sub_id) {
...
function messageBlockAdd($block_id, $sub_id) {
...
function messageBlockDel($block_id, $sub_id) {
}
