...
function wiki_showMain($idBlock, $title, $block_op) {
	...
	require_once($GLOBALS["where_cms"]."/modules/wiki/functions.php");


	$GLOBALS["page"]->add("<div class=\"body_block\">\n", "content");

	if (isset($GLOBALS["core_wiki_public"])) {
		unset($GLOBALS["core_wiki_public"]);
	}
	wikiMain($opt["wiki_id"]);
