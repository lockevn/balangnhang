...
require_once($GLOBALS["where_ecom"]."/admin/modules/bought/lib.bought.php");


function baSetup() {
	if (!isset($GLOBALS["bought_admin"]))
		$GLOBALS["bought_admin"]=new ReservationAdmin();

	$ra=& $GLOBALS["bought_admin"];
	$ra->urlManagerSetup("modname=bought&op=main");
}
