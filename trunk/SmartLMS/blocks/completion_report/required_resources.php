...
<?php
 ...
 /**
 * required_resources.php - part of block_completion_report
 *            - displays the required resources of a specified course
 *              according in the configured rubrics using the configure page
