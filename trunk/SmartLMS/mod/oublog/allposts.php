...
EOF;
    ...
    print_header_simple(format_string($oublog->name), "", $navigation, "", get_oublog_meta_tags($oublog, 'all', '', $context), true,
...
print '<div id="right-column">';
    ...
    if ($feeds = oublog_get_feedblock($oublog, 'all', '', false, $context)) {
