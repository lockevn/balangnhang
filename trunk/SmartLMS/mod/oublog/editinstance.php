...
/// Set-up groups
    ...
    /// Print the header
        ...
        $navlinks[] = array('name' => format_string($oubloginstance->name), 'link' => 'view.php?id='.$oubloguser->id, 'type' => 'activityinstance');
        $navlinks[] = array('name' => $strblogoptions, 'link' => '', 'type' => 'misc');
