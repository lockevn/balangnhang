...
//define('GLOBAL_COURSE_ID_TO_BIND_MAIL', 1);
...
//se crean las carpetas entrada y salida gen?ricas que servir?n para todos los usuarios de ese mail
...
function mail_delete_course($course, $feedback=true) {
	...
	$result = true;
	//Se deber?n borrar los archivos que se subieron en las carpetas correspondientes
