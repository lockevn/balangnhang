...
<?php elseif($this->state === 'depositfail'):  ?>
	<div class="info">Deposit Fail! Please use correct card code.</div> 
<?php else:  ?>    
...
<fieldset >
	...
	<input type='text' id='username' value = '<?=$USER->username ?>' maxlength="50"><br />
	<label for="code">Code: </label>
	<input type='text' id='code' value = '' maxlength="50"><br />
