...
function xmldb_smartcom_upgrade($oldversion=0) {
...
/// for demonstrative purposes and to show how the smartcom
/// iself has been upgraded.

/// For each upgrade block, the file smartcom/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to smartcom
        $table = new XMLDBTable('smartcom');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to smartcom
        $table = new XMLDBTable('smartcom');
    ...
    /// Define field introformat to be added to smartcom
        $table = new XMLDBTable('smartcom');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to smartcom
        $table = new XMLDBTable('smartcom');
    ...
    /// Define field timemodified to be added to smartcom
        $table = new XMLDBTable('smartcom');
    ...
    /// Define index course (not unique) to be added to smartcom
        $table = new XMLDBTable('smartcom');
