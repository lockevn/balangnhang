...
define("REND_TITLE_CLOSE", "treeview/menu_folder_closed.gif");
define("REND_TITLE_OPEN_LEAF", "treeview/menu_folder_open_leaf.gif");
define("REND_TITLE_OPEN", "treeview/menu_folder_open.gif");
define("REND_ROOT", "treeview/menu_root.gif");
...
class TreeView {
	...
	function _getOpPlayItemImg() 	{ return getPathImage().'standard/view.gif';	}
	...
	function _getCancelImage() { return getPathImage().'standard/undo.gif'; }

	function _getFolderNameLabel() { return $this->lang->def('_NAME'); }
	function _getAddLabel() { return $this->lang->def('_NEWFOLDER'); }
	function _getAddUrl() { return $this->_getOpNewFolderId(); }
	function _getAddAlt() { return $this->lang->def('_NEWFOLDER'); }
	function _getAddImage() { return getPathImage().'standard/add.gif'; }

	function _getCreateLabel() { return $this->lang->def('_CREATEFOLDER'); }
	function _getCreateUrl() { return $this->_getCreateFolderId(); }
	function _getCreateAlt() { return $this->lang->def('_CREATEFOLDER'); }
	function _getCreateImage() { return getPathImage().'standard/add.gif'; }

	function _getRenameLabel() { return $this->lang->def('_RENAMEFOLDER'); }
	function _getRenameUrl() { return $this->_getOpRenameFolderId(); }
	function _getRenameAlt() { return $this->lang->def('_RENAMEFOLDER'); }
	function _getRenameImage() { return getPathImage().'treeview/rename.png'; }

	function _getDeleteLabel() { return $this->lang->def('_DELETEFOLDER'); }
	function _getDeleteUrl() { return $this->_getOpDeleteFolderId(); }
	function _getDeleteAlt() { return $this->lang->def('_DELETEFOLDER'); }
	function _getDeleteImage() { return getPathImage().'standard/rem.gif'; }

	function _getMoveLabel() { return $this->lang->def('_ALT_MOVE'); }
	function _getMoveUrl() { return $this->_getOpMoveFolderId(); }
	function _getMoveAlt() { return $this->lang->def('_ALT_MOVE'); }
	function _getMoveImage() { return getPathImage().'treeview/move.png'; }
	function _getMoveTargetLabel() { return $this->lang->def('_TARGETMOVEFOLDER'); }
	...
	function getItemToPlay() {	return $this->itemToPlay; }
	...
	function setState( $arr_state ) {
		...
		if( isset( $arr_state['itemToPlay'] ) )
			$this->itemToPlay = $arr_state['itemToPlay'];
		...
		if( $maxLev == 0 ) {
			...
			if( $stack[$maxLev]['isExpanded'] ) {
				if( $stack[$maxLev]['isLeaf'] ) {
					...
					$imgAlt = $this->lang->def('_ALT_TITLE_OPEN_LEAF');
				} else {
					$imgFileName = REND_TITLE_OPEN;
					$imgAlt = $this->lang->def('_ALT_TITLE_OPEN');
				}
			} else {
				$imgFileName = REND_TITLE_CLOSE;
				$imgAlt = $this->lang->def('_ALT_TITLE_CLOSE');
			}
			...
			if( $stack[$currLev+1]['isLast'] ) {
				...
				$imgAlt = $this->lang->def('_ALT_VERT_INTER');
			}
		}
