...
$plf = get_req('plf', DOTY_ALPHANUM, ( $_SESSION['current_action_platform'] ? $_SESSION['current_action_platform'] : $GLOBALS['platform'] ));

if($mn == '') {
	
	$fl = get_req('file', DOTY_ALPHANUM, '');
	$aj_file = $GLOBALS['where_'.$plf].'/lib/ajax.'.$fl.'.php';
} else {
