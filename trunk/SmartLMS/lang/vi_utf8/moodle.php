...
$string['actions'] = 'Thực hiện';
$string['active'] = 'Hoạt động';
$string['activeusers'] = 'Kích hoạt người dùng';
...
$string['addedtogroupnotenrolled'] = 'Không được thêm tới nhóm $a, bởi vì không được tham gia vào khóa học';
...
$string['addnewcourse'] = 'Thêm một khóa học mới';
...
$string['adminhelpassigncreators'] = 'Những người tạo khóa học có thể tạo một khóa học mới và dạy trong đó';
$string['adminhelpassignstudents'] = 'Đi vào trong một khóa học và thêm các học viên từ danh sách quản trị';
$string['adminhelpassignteachers'] = 'Tìm một khóa học sau đó sử dụng biẻu tượng để thêm các giáo viên';
...
$string['adminhelpcourses'] = 'Định nghĩa các khóa học, các danh mục và phân công mọi người quản lý chúng';
...
$string['adminhelpenvironment'] = 'Kiểm tra xem server của bạn có đáp ứng yêu cầu phiên bản hiện thời và các phiên bản trong tương lai';
$string['adminhelpfailurelogs'] = 'Duyệt thông tin lưu đăng nhập thất bại';
$string['adminhelphealthcenter'] = 'Tự động phát hiện ra các vấn đề của site';
...
$string['adminhelpmymoodle'] = 'Cấu hình các khối của my moodle cho người dùng';
$string['adminhelpreports'] = 'Các báo cáo về site';
...
$string['allowguests'] = 'Khóa học này cho phép khách vào';
...
$string['areyousuretorestorethisinfo'] = 'Sau đó trong quy trình này bạn sẽ có một lựa chọn thêm bản sao dự phòng này tới một khóa học đã tồn tại hoặc một khóa học mới hoàn toàn.';
...
$string['assignstudentsnote'] = 'Chú ý rằng: Có thể không cần thiết sử dụng trang này, trang này có khả năng kết nạp các học viên vào trong khóa học này.';
$string['assignstudentspass'] = 'Tất cả những việc bạn cần làm là thông báo cho các học viên của bạn khóa truy cập khóa học này, hiện hành nó được thiết lập là : \'$a\'';
...
$string['backupcoursefileshelp'] = 'Nếu có thể thì các tài liệu khóa học sẽ bao gồm cẳ những bản sao dự phòng tự động';
$string['backupdate'] = 'Ngày sao lưu';
$string['backupdetails'] = 'Chi tiết sao lưu';
$string['backupfailed'] = 'Một số khóa học của bạn không được lưu!!';
$string['backupfilename'] = 'sao lưu';
$string['backupfinished'] = 'Sao lưu đã được hoàn thành một cách thành công';
$string['backupincludemoduleshelp'] = 'Chọn khi nào bạn muốn bao gồm cả các môđun khóa học, có hoặc không có dữ liệu người dùng, trong các bản sao dự phòng một cách tự động';
$string['backupkeephelp'] = 'Bao nhiêu bản sao lưu dự phòng gần đây cho mỗi khóa học bạn muốn giũ lại? (Các bản sao lưu cũ hơn sẽ bị xoá một cách tự động )';
$string['backuplogdetailed'] = 'Bản ghi thể hiện một cách chi tiết';
$string['backuploglaststatus'] = 'Bản ghi thực hiện mới nhất';
$string['backuplogshelp'] = 'Nếu có thể, thì các bản ghi khóa học sẽ bao gồm cả các bản sao lưu dự phòng tự động';
...
$string['backupsavetohelp'] = 'Đường dẫn đầy đủ tới thư mục mà ở đó bạn muốn lưu những file dự phòng <br />( để trống để lưu vào trong thư mục mặc định của khóa học )';
...
$string['backupusershelp'] = 'Chọn khi nào bạn muốn bao gồm cả tất cả những người dùng trên máy chủ hoặc chỉ những người dùng cần thiết đối với mỗi khóa học';
...
$string['bycourseorder'] = 'Theo thứ tự khóa học';
$string['byname'] = 'bởi $a';
$string['cancel'] = 'Huỷ';
$string['categories'] = 'Các danh mục khóa học';
...
$string['checkingcourse'] = 'Đang kiểm tra khóa học';
...
$string['choosecourse'] = 'Chọn một khóa học';
...
$string['continuetocourse'] = 'Kích vào đây để đi vào khóa học của bạn';
$string['cookiesenabled'] = 'Cookies phải được cho phép trong trình duyệt của bạn';
$string['copy'] = 'copy';
$string['copyingcoursefiles'] = 'Copy các tài liệu khóa học';
...
$string['courseavailable'] = 'Khóa học này học viên không vào được';
$string['courseavailablenot'] = 'Khóa học học viên không vào được';
$string['coursebackup'] = 'Sao lưu khóa học';
$string['coursecategories'] = 'Các danh mục khóa học';
$string['coursecategory'] = 'Danh mục khóa học';
$string['coursecreators'] = 'Những nhà tạo khóa học';
$string['coursefiles'] = 'Các tài liệu khóa học';
$string['courseformats'] = 'Các dịnh dạng khóa học';
$string['coursegrades'] = 'Các điểm khóa học';
$string['courseinfo'] = 'Thông tin khóa học';
$string['courserestore'] = 'Khôi phục lại khóa học';
$string['courses'] = 'Các khóa học đã chọn';
$string['courseselect'] = 'Chọn khóa học';
$string['courseupdates'] = 'khóa học được cập nhật';
$string['courseuploadlimit'] = 'Giới hạn khóa học tải lên';
$string['create'] = 'Tạo';
...
$string['creatingcoursemodules'] = 'Tạo các môđun khóa học';
...
$string['creatingnewcourse'] = 'Tạo khóa học mới';
...
$string['currentcourseadding'] = 'Khóa học hiện thời, thêm dữ liệu vào';
$string['currentcoursedeleting'] = 'Khóa học hiện thời,xoá nó lần đầu';
...
$string['defaultcoursefullname'] = 'Tên đầy đủ khóa học 101';
$string['defaultcourseshortname'] = 'CF101';
$string['defaultcoursestudent'] = 'Học viên';
$string['defaultcoursestudents'] = 'Các học viên';
$string['defaultcoursesummary'] = 'Viết một đoạn ngắn gọn và có sức lôi cuốn người đọc ở đây nhằm  giải thích về nội dung chính của khóa học này';
$string['defaultcourseteacher'] = 'Giáo viên';
$string['defaultcourseteachers'] = 'Các giáo viên';
$string['delete'] = 'Xoá';
$string['deleteall'] = 'Xoá tất cả';
$string['deletecategorycheck'] = 'Bạn có chắc chắn muốn danh mục này <b>\'$a\'</b>?<br /> Điều này sẽ di chuyển tất cả các khóa học vào trong danh mục gốc nếu chỉ có một, hoặc vào trong danh mục hỗn hợp.';
...
$string['deletecourse'] = 'Xoá một khóa học';
$string['deletecoursecheck'] = 'Bạn có chắc chắn muốn xoá khóa học này và tất cả dữ liệu nó chứa ?';
...
$string['deletingexistingcoursedata'] = 'Xoá dữ liệu khóa học đã tồn tại';
...
$string['editcoursesettings'] = 'Soạn thảo các thiết lập khóa học';
...
$string['emaildisplaycourse'] = 'Chỉ cho phép những thành viên khóa học khác nhìn thấy địa chỉ email';
...
$string['enrolledincourse'] = 'Được tham gia vào khóa học \"$a\"';
$string['enrolledincoursenot'] = 'Không được tham gia vào khóa học \"$a\"';
$string['enrollfirst'] = 'Bạn phải được tham gia vào một trong các khóa học trước khi bạn có thể sử dụng các hoạt động của Site';
$string['enrolmentconfirmation'] = 'Bạn muốn tự mình tham gia như một thành viên của khóa học này.<br />Bạn có chắc chắn muốn làm điều này?';
$string['enrolmentkey'] = 'Khoá truy cập';
$string['enrolmentkeyfrom'] = 'khóa học này yêu cầu một \'khoá truy cập\' - một<br />
...
$string['enrolmentnewuser'] = '$a->user được tham gia vào trong khóa học \"$a->course\"';
$string['enrolmentnointernal'] = 'Các kết nạp bằng tay hiện hành không được cho phép';
$string['enrolmentnotyet'] = 'Xin lỗi, bạn không thể truy cập khóa học này cho tới khi <br /> $a';
$string['enrolments'] = 'Các kết nạp';
$string['enrolperiod'] = 'Giai đoạn được tham gia';
$string['entercourse'] = 'Nhắp chuột để vào khóa học này';
...
$string['existingcourse'] = 'khóa học đã tồn tại';
$string['existingcourseadding'] = 'khóa học đã tồn tại, thêm dữ liệu vào nó';
$string['existingcoursedeleting'] = 'khóa học đã tồn tại, xoá nó lần đầu';
$string['existingcreators'] = 'Những nhà tạo khóa học đã tồn tại';
...
$string['findmorecourses'] = 'Tìm nhiều khóa học hơn...';
...
$string['frontpagecourselist'] = 'Hiện một danh sách các khóa học';
...
$string['fulllistofcourses'] = 'Tất cả các khóa học';
...
$string['guestuserinfo'] = 'Người dùng này là một người dùng đặc biệt mà cho phép truy cập chỉ xem tới một số khóa học.';
...
$string['includecoursefiles'] = 'Bao gồm tất cả các tài liệu khóa học';
$string['includecourseusers'] = 'Bao gồm những người dùng khóa học';
...
$string['lastaccess'] = 'Lần truy cập trước';
...
$string['loginsteps'] = 'Xin chào! Để có thể truy cập vào các khóa học bạn sẽ phải mất
   vài phút để tạo một account mới cho chính bạn trên web site này.
   Mỗi khóa học riêng biệt có thể có một \"khoá truy cập \", nhưng bạn chưa cần chúng bây giờ.
   Sau đây là các bước:
   <ol>
   ...
   <li>Bây giờ chọn khóa học bạn muốn tham gia vào.</li>
   <li>Nếu bạn bị nhắc phải điền vào \" một khoá truy cập\"- sử dụng khoá truy cập mà
   giáo viên của bạn đưa cho bạn. Khi đó bạn sẽ được tham gia vào trong khóa học.</li>
   <li>Bây giờ bạn có thể truy cập toàn bộ khóa học. Từ bây giờ trở đi bạn chỉ cần
   nhập tên đăng nhập và mật khẩu của bạn (trong biểu mẫu của trang này )
   để đăng nhập và truy cập các khóa học bạn đã đăng ký.</li>
   </ol>';
$string['loginstepsnone'] = '<p>Hi!</p>
<p> Để truy cập các khóa học bạn cần tạo cho riêng mình một tài khoản.</p>
...
$string['mailadmins'] = 'Thông tin các quản trị';
...
$string['moveselectedcoursesto'] = 'Di chuyển các khóa học được chọn tới...';
...
Trong hầu hết các chương trình mail, nó sẽ xuất hiện như một link màu xanh
...
Lời chào từ \'$a->sitename\' administrator,
$a->signoff';
...
$string['newusernewpasswordtext'] = 'Một tài khoản được tạo cho bạn tại \'$a->sitename\'
và bạn được cấp cho một mật khẩu tạm thời.

Thông tin đăng nhập hiện thời của bạn là:
tên đăng nhập: $a->username
mật khẩu: $a->newpassword
(bạn sẽ phải thay đổi mật khẩu
khi bạn đăng nhập lần đầu tiên)

Để bắt đầu sử dụng \'$a->sitename\', đăng nhập tại
$a->link
...
$string['nocoursesfound'] = 'Không có khóa học nào được tìm thấy với những từ \'$a\'';
$string['nocoursesyet'] = 'Không có khóa học nào trong danh mục này';
...
$string['noexistingcreators'] = 'Không tồn tại nhà tạo khóa học nào';
...
$string['nofilesyet'] = 'Không có tài liệu nào được tải lên khóa học của bạn';
$string['nograde'] = 'Không có điểm';
$string['noimagesyet'] = 'Chưa có hình ảnh nào được tải lên khóa học của bạn';
$string['nomorecourses'] = 'Không tìm thấy một khóa học nào nữa';
$string['nomoreidnumber'] = 'Không sử dụng môt idnumber để tránh đụng độ';
$string['none'] = 'Không';
$string['nopendingcourses'] = 'Không có khóa học nào cần duyệt';
$string['nopotentialadmins'] = 'Không có các quản trị viên tiềm năng';
$string['nopotentialcreators'] = 'Không có các nhà tạo khóa học tiềm năng';
...
$string['nostudentsyet'] = 'Chưa có học viên nào được kết nạp trong khóa học này';
$string['nosuchemail'] = 'Không có địa chỉ email như thế';
$string['notavailable'] = 'Không có sẵn';
$string['noteachersyet'] = 'Không có giáo viên nào trong khóa học này';
$string['notenrollable'] = 'Không thể vào khóa học vào thời điểm hiện tại';
$string['notenrolled'] = '$a không được kết nạp trong khóa học này.';
$string['noteuserschangednonetocourse'] = 'Chú ý rằng: người dùng khóa học cần được tạo lại khi tạo dữ liệu người dùng. Thiết lập này được thay đổi đối với bạn.';
...
$string['paymentrequired'] = 'khóa học này yêu cầu một chi phí đối với mục nhập.';
$string['paymentsorry'] = 'Cám ơn đã thanh toán! Không may sự thanh toán của bạn chưa được giải quyết một cách đầy đủ, và bạn chưa được đăng ký để vào khóa học \"$a->fullname\".  Vui lòng thử tiếp tục khóa học trong ít phút nữa, nhưng nếu bạn tiếp tục gặp phải vấn đề này thì vui lòng báo cho $a->teacher hoặc quản trị site';
$string['paymentthanks'] = 'Cám ơn về sự thanh toán của bạn! Bây giờ bạn được tham gia trong khóa học của bạn :<br />\"$a\"';
...
$string['potentialcreators'] = 'Các nhà tạo khóa học tiềm năng';
...
$string['removecreator'] = 'Gỡ bỏ người tạo khóa học';
...
$string['requireskey'] = 'khóa học này yêu cầu một khoá truy cập';
$string['requirespayment'] = 'khóa học này yêu cầu trả lệ phí truy cập';
$string['resortcoursesbyname'] = 'Sắp xếp lại các khóa học theo tên';
$string['resources'] = 'Tài nguyên';
$string['restore'] = 'Khôi phục';
$string['restorecancelled'] = 'Khôi phục được huỷ';
$string['restorecoursenow'] = 'Khôi phục khóa học này bây giờ!';
...
$string['seealsostats'] = 'Xem thêm: thống kê';
...
$string['shortnametaken'] = 'Tên rút gọn được sử dụng cho khóa học khác rồi($a)';
$string['shortsitename'] = 'Tên Site rút gọn';
$string['show'] = 'Hiện';
$string['showall'] = 'Hiện tất cả $a';
$string['showallcourses'] = 'Hiện tất cả các khóa học';
...
$string['showlistofcourses'] = 'Hiện danh sách các khóa học';
$string['showonly'] = 'Chỉ hiện thị';
...
$string['someallowguest'] = 'Một số khóa học có thể cho phép khách truy cập';
...
$string['studentnotallowed'] = 'Xin lỗi bạn, nhưng bạn không thể vào khóa học này như là \'$a\'';
...
$string['total'] = 'Tổng';
$string['trackforums'] = 'Theo dõi diễn đàn';
$string['trackforumsno'] = 'Không: Đừng theo dõi các bài viết tôi vừa nhìn';
$string['trackforumsyes'] = 'Vâng: đánh dấu các bài viết mới cho tôi';
...
$string['unenrolallstudentssure'] = 'Bạn có chắc chắn muốn hoàn thành việc gỡ kết nạp các học viên từ khóa học này?';
$string['unenrolme'] = 'Gỡ bỏ tôi từ $a';
$string['unenrolsure'] = 'Bạn có chắc chắn muốn gỡ bỏ $a từ khóa học này ?';
...
$string['untilcomplete'] = 'Cho đến khi hoàn thành';
...
$string['userchangavatar'] = 'Đăng ảnh mới';
...
$string['usernameemailmatch'] = 'Tên người dùng và địa chỉ email không phù hợp với cùng một người dùng';
$string['usernameexists'] = 'Tên đăng nhập này sẵn sàng tồn tại, chọn tên khác';
$string['usernamenotfound'] = 'Tên đăng nhập không tìm thấy trong database';
...
$string['usersnoaccesssince'] = 'Hiên thị các người dùng không tham gia hơn';
$string['userzones'] = 'Khu vực dành cho người dùng';
$string['usethiscourse'] = 'Sử dụng khóa học này';
$string['usingexistingcourse'] = 'Sử dụng khóa học có sẵn';
$string['version'] = 'Phiên bản';
$string['view'] = 'Quan sát';
$string['viewsolution'] = 'xem lời giải';
$string['virusfound'] = 'Quản trị viên chú ý! Clam AV tìm thấy một virút trong một file được tải lên bởi $a->user đối với khóa học $a->course. Đây là đầu ra của clamscan:';
$string['virusfoundlater'] = 'Một file bạn tải lên vào  $a->date với tên file $a->filename đối khóa học $a->course được tìm thấy chứa một virút. Đây là một tổng kết về những gì xảy ra đối với file của bạn file:

$a->action

Nếu đây là công việc được đưa ra, bạn có thể muốn đưa ra nó cho tới khi người giám hộ của bạn có thể nhìn thấy nó.';
$string['virusfoundlateradmin'] = 'Quản trị viên chú ý! Một file mà nó được tải lên vào ngày $a->date với tên file $a->filename đối với khóa học $a->course bời người dùng $a->user tìm thấy chứa một virút.  Đây là một tổng kết về những gì xảy ra đối với  file:
...
$string['warningdeleteresource'] = 'Cảnh báo: $a được tham chiếu bởi 1 tài nguyên. Bạn có muốn cập nhật tài nguyên?';
...
$string['writingcoursedata'] = 'Ghi dữ liệu khóa học';
