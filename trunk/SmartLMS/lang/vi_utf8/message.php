...
$string['addsomecontacts'] = 'Để gửi thông điệp tới bạn bè, hoặc tìm kiếm tin nhắn, hãy click vào mục <a href=\"$a\">tìm kiếm</a> ở trên.';
...
$string['contactlistempty'] = 'Danh sách bạn bè của bạn: Chưa có ai';
$string['contacts'] = 'Tin nhắn mới';
$string['deletemessagesdays'] = 'Số ngày trước khi các thông điệp cũ được xoá tự động';
$string['discussion'] = 'Thảo luận';
$string['emailmessages'] = 'Gửi cho tôi các thông điệp khi tôi không truy cập Smartweb';
...
$string['savemysettings'] = 'Lưu cài đặt mới';
...
$string['settings'] = 'Cài đặt tin nhắn';
